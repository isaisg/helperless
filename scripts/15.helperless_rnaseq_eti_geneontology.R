...
oh.save.pdf(p = p,outname = "geneontology_eti_up.pdf",
            outdir = "../figures/",width = 16,height = 21,family = "Arial")


write.table(x = df_plot[,-1],
            file = "../cleandata/suptable_go_upregulated.csv",append = F,quote = F,sep = "\t",row.names = F,col.names = T)
...
oh.save.pdf(p = p,outname = "geneontology_eti_down.pdf",
            outdir = "../figures/",width = 16,height = 21,family = "Arial")
